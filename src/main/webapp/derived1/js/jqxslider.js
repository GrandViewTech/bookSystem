...
(function(a) {
    ...
    a.extend(a.jqx._jqxSlider.prototype, {
        ...
        _addTick: function(b, i, n, p, c, j, o) {
            ...
            if (this.template) {
                q += " " + this.toThemeProperty("jqx-" + this.template)
            }
            var e;
        ...
        _performLayout: function() {
            ...
            if (this.orientation == "horizontal") {
                ...
                if (!this.showButtons || this.rangeSlider) {
                    var d = (2 + Math.ceil(this.sliderButtonSize / 2));
                    this._contentWrapper.css("left", d)
                }
            }
            if (this.rangeSlider) {
        ...
        _performTrackLayout: function(b) {
            var c = b - ((this.showButtons && !this.rangeSlider) ? this._leftButton[this._getSetting("outerSize")](true) + this._rightButton[this._getSetting("outerSize")](true) : 0);
            if (this.rangeSlider || !this.showButtons) {
                var d = (2 + Math.ceil(this.sliderButtonSize / 2));
                c = b - 2 * d
            }
            this._track[this._getSetting("size")](c);
        ...
        _performTicksContainerLayout: function() {
            ...
            var d = -2 + (parseInt(this.host[e]()) - this._track[b](true)) / 2;
            this._topTicks[e](parseInt(d));
            var c = -2 + (parseInt(this.host[e]()) - this._track[b](true)) / 2;
        ...
        _getFloatingValueByPosition: function(b) {
            var c = b - this._track.coord()[this._getSetting("left")] + this._slider.left.width() / 2,
                g = c / this._track[this._getSetting("size")](),
                h;
            if (c < 0) {
                c = 0
            }
        ...
        _getFixedValueByPosition: function(f) {
            var j = this._getTrackSize(),
                d = this._getThumbSize(),
                l = {
                    number: -1,
            ...
            if (this.int64 === false) {
                ...
                h = (j) / g;
                k = this._track.coord()[this._getSetting("left")] - d / 2;
                var i = this.max + this.step;
                if (this.mode == "fixedRange") {
                    i = this.max
                }
                for (var e = this.min; e <= i; e += this.step) {
                    if (Math.abs(l.distance - f) > Math.abs(k - f)) {
                        l.distance = k;
                        l.number = e
                    }
                    k += h
                ...
                h = new a.jqx.math().fromNumber(j, 10).div(g).toNumber();
                k = this._track.coord()[this._getSetting("left")] - d / 2;
                l = {
                    number: new a.jqx.math().fromString(this._min64.toString(), 10),
                    distance: k
                };
                for (var b = new a.jqx.math().fromString(this._min64.toString(), 10); this.mode != "fixedRange" ? b.lessThanOrEqual(this._max64.add(this._step64)) : b.lessThanOrEqual(this._max64); b = b.add(this._step64)) {
                    if (Math.abs(l.distance - f) > Math.abs(k - f)) {
                        l.distance = k;
                        l.number = new a.jqx.math().fromString(b.toString(), 10)
                    }
                    k += h
                }
            }
            if (this.layout == "normal") {
                if (this.orientation === "horizontal" && !this.rtl) {
                    ...
                    return (this.max + this.min) - l.number
                }
            } else {
                if (this.orientation === "horizontal" && !this.rtl) {
                    return (this.max + this.min) - l.number
        ...
        _handleValue: function(c, b) {
            ...
            if (this.rangeSlider) {
                ...
                if (this.int64 === true) {
                    this._value64 = {
                        rangeStart: this._values64[0],
                        rangeEnd: this._values64[1]
                    }
                }
            } else {
                if (this.int64 === false) {
        ...
        _setSliderPosition: function(h, c, b) {
            var f = this._track[this._getSetting("size")](),
                e, i;
            if (b) {
        ...
        propertyChangedHandler: function(b, c, f, e) {
            ...
            switch (c) {
                case "template":
                    if (b.template) {
                        b._slider.left.removeClass(b.toThemeProperty("jqx-" + f));
                        b._slider.right.removeClass(b.toThemeProperty("jqx-" + f));
                        b._rangeBar.removeClass(b.toThemeProperty("jqx-" + f));
                        b._slider.left.addClass(b.toThemeProperty("jqx-" + b.template));
                        b._slider.right.addClass(b.toThemeProperty("jqx-" + b.template));
                        ...
                        b._rangeBar.addClass(b.toThemeProperty("jqx-" + b.template))
                    }
                    break;
                case "theme":
