...
app.controller( 'toolsUploadController',  function($scope, $http, $window, $filter, fileUpload) {
	...
	$scope.uploadFile = function(){
               ...
               var url = '../ws/rest/digitalToolService/uploadDigitalToolsExcel/token/test';
